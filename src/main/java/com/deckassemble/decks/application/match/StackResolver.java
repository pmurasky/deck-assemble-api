...
final class StackResolver {
    ...
    void cascadeLimit(int limit) {
        cascadeLimit = limit;
    }

    void givePriorityTo(PlayerId holder) {
        priorityHolder = holder;
    }
