...
/**
 * Starts a solitaire turn-stepped practice session from a deck revision's snapshot: an opening hand
 * (same mulligan mechanics as {@link DeckSimulationRequest}) is kept, then each step advances one
 * turn of draw / land-drop / cast. {@code onThePlay} skips the turn-1 draw. {@code seed} is
